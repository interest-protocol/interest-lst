...
module interest_framework::fixed_point64 {
    use interest_framework::constants::u256_max_u128;
    ...
    public fun add(x: FixedPoint64, y: FixedPoint64): FixedPoint64 {
        ...
        assert!(result <= u256_max_u128(), EOutOfRange);
    ...
    public fun multiply_u128(val: u128, multiplier: FixedPoint64): u128 {
        ...
        assert!(product <= u256_max_u128(), EMultiplicationOverflow);
        (product as u128)
    }
    spec multiply_u128 {
        pragma opaque;
    ...
    public fun divide_u128(val: u128, divisor: FixedPoint64): u128 {
        ...
        // Check whether the value is too large.
        assert!(quotient <= u256_max_u128(), EDivisionOverflow);
    ...
    public fun create_from_rational(numerator: u128, denominator: u128): FixedPoint64 {
        ...
        // can succeed.
        assert!(quotient <= u256_max_u128(), EOutOfRange);
